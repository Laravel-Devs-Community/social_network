<aside class="bg-blue-200 z-20 hidden w-60 overflow-y-auto md:block flex-shrink-0">
    ...
    <div class="h-14 flex justify-center">
        <img src="/img/logo.png" class="bg-blue-100 w-32 h-24 mt-10">
    </div>

    <div class="justify-start">

        <div class="mt-24 p-2 flex">
            <a href="{{ route('home') }}" class="relative w-full flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 {{ request()->routeIs('home') ? 'bg-white' :'' }}">
        ...
        <div class="p-2 flex">
            <a href="{{ route('notifications') }}" class="relative w-full flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 {{ request()->routeIs('notifications') ? 'bg-white' :'' }}">
                <span class="inline-flex justify-center items-center ml-4">
        ...
        <div class="p-2 flex">
            <a href="{{ route('messages') }}" class="relative w-full flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 {{ request()->routeIs('messages') ? 'bg-white' :'' }}">
                <span class="inline-flex justify-center items-center ml-4">
        ...
        <div class="p-2 flex">
            <a href="{{ route('friends') }}" class="relative w-full flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 {{ request()->routeIs('friends') ? 'bg-white' :'' }}">
                <span class="inline-flex justify-center items-center ml-4">
        ...
        <div class="p-2 flex">
            <a href="{{ route('profile.show') }}" class="relative w-full flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 {{ request()->routeIs('profile.show') ? 'bg-white' :'' }}">
                <span class="inline-flex justify-center items-center ml-4">
